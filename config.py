...
SIZE_PER_TRADE = 10
TX_ENTRY_GAP = [10, 32, 42, 52, 62, 72, 82, 102, 122, 142]
...
POSITION_SIZE_THRESHOLD = [250000 * i for i in [0.005, 0.5, 1, 2, 3, 4, 5, 6, 7, 8]]

N_QUARTERLY_FUTURE = 'BTC-25SEP20'

N_SIZE_PER_TRADE = 500
N_TX_ENTRY_GAP = [62, 82, 102, 122, 152, 192, 242, 302, 372]
N_TX_ENTRY_GAP_CANCEL_DELTA = 3
N_TX_EXIT_GAP = 28
N_TX_EXIT_GAP_CANCEL = TX_EXIT_GAP + 2
N_POSITION_SIZE_THRESHOLD = [150000 * i for i in [0.5, 1, 2, 3, 4, 5, 6, 7, 8]]
